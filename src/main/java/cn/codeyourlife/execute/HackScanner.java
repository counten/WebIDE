 ...
 * 2. 几个方法的返回参数类型：java.util.Scanner -> cn.codeyourlife.execute.HackScanner
 *
...
public final class HackScanner implements Iterator<String>, Closeable {
     ...
     * @return this scanner
     */
    public cn.codeyourlife.execute.HackScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public cn.codeyourlife.execute.HackScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public cn.codeyourlife.execute.HackScanner useLocale(Locale locale) {
     ...
     */
    public cn.codeyourlife.execute.HackScanner useRadix(int radix) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public cn.codeyourlife.execute.HackScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public cn.codeyourlife.execute.HackScanner skip(String pattern) {
     ...
     * @since 1.6
     */
    public cn.codeyourlife.execute.HackScanner reset() {
